...
class StereoStitcher:
    ...
    #Apply sharpening filter to improve edge quality"""
...
class StereoStitchNode(Node):
    def __init__(self, camera_index=2, n_features=3000, match_threshold=0.75):
...
def main(args=None):
    ...
    node = StereoStitchNode(camera_index=2)
